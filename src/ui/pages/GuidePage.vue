...
<template>
  <div>
    ...
    <div class="panel" style="margin-bottom:12px">
      <h3>🌅 退坑转生</h3>
      <p class="mut">当精通足够多的桌游后，可以选择「退坑出清」：本周目的收藏、实体、金钱、属性、职业都会重置，但会换来「桌游阅历」——精通越多、图鉴越全，阅历越多。阅历可以在转生页投资<b>永久天赋</b>（收藏、效率、商业三条线），之后的每个新周目都带着天赋重新三选一开局，越玩越强；生涯统计始终保留。天赋随时可以洗点重分，放心试错。转生后会先停留在转生页，可以立刻用新到账的阅历投资天赋（想在开局生效的「老友馈赠」等要在点「开启新周目」前买好），再手动开始三选一。</p>
    </div>
