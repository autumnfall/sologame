 ...
 * v15 = 桌游设计师（designer 状态 + Copy.designed）；均为新增可选字段，归一化补默认。
 * v16 = 设计师 v5（曝光/预热/平台/事件/两阶段抽成结算）；normalize 兼容旧 campaign/funded 形态。
 */
